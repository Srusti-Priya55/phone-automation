...
const JSON_LOCAL_FILE   = path.resolve(__dirname, '../../apps/nap_json5.txt') // file you push
const JSON_REMOTE_FILE  = '/sdcard/nap_json5.txt'
const JSON_PATH_TO_TYPE = '/sdcard/nap_json5.txt' // <— the path you want to type
